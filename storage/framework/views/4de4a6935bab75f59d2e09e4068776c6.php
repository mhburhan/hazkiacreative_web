    ...
    <div class="container mx-auto p-4">
        ...
        <?php if($cartItems->isEmpty()): ?>
            <div class="text-center">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="mt-4 inline-block bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Belanja Sekarang</a>
            </div>
        <?php else: ?>
            <div class="overflow-x-auto">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6"><?php echo e($item->product->name); ?></td>
                                <td class="py-3 px-6">Rp <?php echo e(number_format($item->product->price, 0, ',', '.')); ?></td>
                                <td class="py-3 px-6"><?php echo e($item->quantity); ?></td>
                                <td class="py-3 px-6">Rp <?php echo e(number_format($item->product->price * $item->quantity, 0, ',', '.')); ?></td>
                            </tr>
                ...
                <div class="mt-6">
                    ...
                    <form action="<?php echo e(route('checkout.process')); ?>" method="POST" class="mt-4" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
                    ...
                    <?php if(session('payment_proof')): ?>
                        <div class="mt-6">
                            <h2 class="text-lg font-bold">Bukti Pembayaran</h2>
                            <img src="<?php echo e(asset('storage/' . session('payment_proof'))); ?>" alt="Bukti Pembayaran" class="mt-2 w-full max-w-md">
                        </div>
                    <?php endif; ?>
                </div>
    ...
    function removeFromCart(itemId) {
        if (confirm('Apakah Anda yakin ingin menghapus item ini dari keranjang?')) {
            $.ajax({
                ...
                <?php /**PATH C:\Users\USER\Downloads\Compressed\TOKO-ONLINE-master\resources\views/carts/index.blade.php ENDPATH**/ ?>